...
- **(26.08.11 발견 및 수정) 경보를 boolean 한 칸으로만 내보내던 문제.**
  ...
  **(26.08.18 재실측)** 라벨 확장안 · 방향 불일치 제외 · 변동성 경보 제거를 거친 지금은
  **full 9건(HI 14.5~54.8) / early 35건(HI 80.7~99.1)**, 여전히 겹침 없음입니다.
  early의 HI 하한이 67.9→78.0→80.7로 올라갔고 건수가 65→35로 준 건 변동성 확대 경보를
  뺐기 때문입니다(26.08.16). 26.08.11판의 "full 10 / early 65 / 78.0"은 폐기.
